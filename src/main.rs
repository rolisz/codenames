...
use crate::game::Game;
use crate::map::Map;
use crate::players::{RandomSpyMaster, SimpleWordVectorFieldOperatives};
...
fn main() {
   ...
   let embeddings: Embeddings<VocabWrap, StorageViewWrap> =
    ...
    let mut blue_sm = SimpleWordVectorSpymaster::new(&embeddings, Blue);
    let mut red_fo = RandomFieldOperatives::new();
    let mut red_sm = RandomSpyMaster::new();
    let mut blue_fo = SimpleWordVectorFieldOperatives::new(&embeddings);
